...
<section
    class="relative mt-20 mx-auto w-full px-[2.5%] lg:px-[5%] 2xl:px-[8%] py-12 md:py-16 lg:py-20 xl:py-24 h-[250px] sm:h-[300px] md:h-[350px] lg:h-[370px] bg-cover bg-center bg-no-repeat "
  ...
  ">
    <div class="container mx-auto text-white h-full flex flex-col justify-center">
        ...
        <!-- Blog Title -->
        <h1
            class="text-white text-4xl sm:text-5xl md:text-[50px] lg:text-[60px] font-semibold leading-[1.2] sm:leading-[1.3] md:leading-[1.4] lg:leading-[110px] tracking-[-0.8px] sm:tracking-[-1px] lg:tracking-[-1.2px] font-poppins mb-4 sm:mb-6">
            Blog Details
        </h1>

        <!-- Background Badge -->
        <div
            class="rounded-[195px] bg-white/10 backdrop-blur-[7px] flex items-center justify-center gap-[10px] px-3 py-2 w-[25%]">
            ...
            <div class="flex items-center gap-1 sm:gap-2">
                <!-- Home Text -->
                <span
                    class="text-white text-xs sm:text-sm md:text-[16px] font-medium leading-none tracking-[-0.24px] sm:tracking-[-0.28px] md:tracking-[-0.32px] font-[Poppins]">
                ...
                <!-- Blog Text -->
                <span
                    class="flex text-white text-xs md:text-[16px] font-medium leading-none tracking-[-0.24px] md:tracking-[-0.32px] font-poppins">
                    <a href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))); ?>">
                        <?php echo esc_html('Blog', 'laundryclean'); ?>
                    </a>
                </span>
                <!-- Dot Separator -->
                <svg xmlns="http://www.w3.org/2000/svg" width="3" height="3" viewBox="0 0 3 3" fill="none">
                ...
                <span
                    class="flex text-white text-xs md:text-[16px] font-medium leading-none tracking-[-0.24px] md:tracking-[-0.32px] font-poppins">
                    <?php echo esc_html('Blog Details', 'laundryclean'); ?>
                </span>
            </div>
        </div>
    </div>
            ...
            <main class="blog-left  w-full lg:w-8/12">
                ...
                <div class="w-full">
                    ...
                    <div class="py-4 md:py-5 xl:pr-4 flex flex-col gap-3 md:gap-[12px]">
                        ...
                        <!-- Second Row - Title -->
                        <div
                            class="text-[#142137] -mt-1 md:-mt-[3px] mb-1 md:mb-[4px] font-poppins text-2xl md:text-3xl lg:text-[34px] font-semibold leading-tight md:leading-[64px] tracking-tight md:tracking-[-0.68px]">
                            <h1>
                        ...
                        <div
                            ...
                            $content_text = preg_replace('/<img[^>]+\>/i', '', $content_text);
                            echo esc_html($content_text);
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <!-- Four Card Author -->
                    <div
                        class="relative mt-8 md:mt-12 w-full mx-auto bg-[#EBEFF3] flex flex-col lg:flex-row gap-6 md:gap-9 lg:gap-12 p-4 md:p-6">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between gap-3 pt-8 md:pt-[80px]">
