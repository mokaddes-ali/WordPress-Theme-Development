...
function laundryclean_about_customizer($customizer){
    //Settings
    $customizer->add_section('_about_section', array(
        'title' => __('About Settings', 'laundryclean'),
        'priority' => 90,
    ));
    ...
    $customizer->add_control('about_title', array(
        'label' => __('About Title', 'laundryclean'),
    ...
    $customizer->add_control('about_subtitle', array(
        'label' => __('About Subtitle', 'laundryclean'),
        'section' => '_about_section',
        'type' => 'text',
    ));
    ...
    $customizer->add_setting('about_description', array(
        'default' => __('Revolutionized the way you think about dry cleaning and laundry. Our mission is simple: to make laundry day hassle-free. With our easy-to-use service, you can enjoy the convenience of professional dry cleaning and laundry.', 'laundryclean'),
    ));
    $customizer->add_control('about_description', array(
        'label' => __('About Description', 'laundryclean'),
        'section' => '_about_section',
        'type' => 'textarea',
    ...
    $customizer->add_control('about_button_text', array(
        'label' => __('About Button Text', 'laundryclean'),
        'section' => '_about_section',
        'type' => 'text',
    ));
    //button url
    ...
    //experience year
    $customizer->add_setting('about_experience_year', array(
        'default' => __('14', 'laundryclean'),
    ));
    $customizer->add_control('about_experience_year', array(
        'label' => __('About Experience Year', 'laundryclean'),
        'section' => '_about_section',
        'type' => 'number',
    ));

    //experience year text
    $customizer->add_setting('about_experience_year_text', array(
        'default' => __('Years Experience', 'laundryclean'),
    ));
    $customizer->add_control('about_experience_year_text', array(
        'label' => __('About Experience Year Text', 'laundryclean'),
        'section' => '_about_section',
        'type' => 'text',
    ));
...
add_action('customize_register', 'laundryclean_about_customizer');
