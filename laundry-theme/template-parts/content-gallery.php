...
<article id="post-<?php the_ID(); ?>" <?php post_class('relative w-full my-3 flex-shrink-0 bg-[#EBEFF3]'); ?>>

 <!-- Next and preview Button -->
     <div class="absolute top-[25%] left-[5%] z-50 flex justify-between items-center w-[90%]">

         <!-- Prev Button -->
          <button id="blog-prev" class="w-[44px] h-[44px] flex items-center justify-center rounded-full hover:bg-[#4375E7] transition duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
  <rect width="50" height="50" rx="25" fill="white"/>
  <path d="M32 25H18" stroke="#142137" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M25 18L18 25L25 32" stroke="#142137" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
         </button>

         <!-- Next Button -->
         <button id="blog-next" class="w-[44px] h-[44px] flex items-center justify-center rounded-full hover:bg-[#4375E7] transition duration-300">
    ...
    <div class="px-4 py-3 lg:px-8 lg:py-6 flex flex-col gap-[14px]">
        ...
        <h1 class="text-[#142137] font-poppins text-[34px] font-semibold leading-[64px] tracking-[-0.68px]">
            <a href="<?php esc_html(the_permalink()); ?>">
                <?php echo esc_html(wp_trim_words(the_title(), 7)); ?>
            </a>
            
        </h1>

        <!-- Third Row - Excerpt Content -->
