...
<!-- About Company -->
<section
  class="w-full bg-[#FFF] mx-auto relative px-[5%] lg:px-[8%] 2xl:px-[10%] py-5 md:py-6 lg:py-8 flex flex-col md:flex-row gap-8 md:gap-5 lg:gap-[50px] 2xl:gap-20">
  ...
  <div class="flex flex-col items-center md:items-start gap-3 md:gap-4 2xl:gap-6 w-full md:w-6/12">
    ...
    <!-- Small Top Label -->
    <div
      class="border border-[rgba(20,33,55,0.14)] flex items-center gap-2 text-[13px] sm:text-[14px] md:text-[15px] font-medium text-[rgba(20,33,55,0.70)] py-1.5 px-3 font-poppins">
      <span class="w-[6px] h-[6px] rounded-full bg-[#142137] flex-shrink-0"></span>
      <?php if ($about_title): echo esc_html($about_title);
      endif; ?>
    </div>
    ...
    <h1 class="text-[#142137] w-full text-center md:text-left font-poppins 
      ...
      <?php if ($about_subtitle): echo esc_html($about_subtitle);
      endif; ?>
    </h1>
    ...
    <p class="text-[rgba(20,33,55,0.70)] text-center md:text-left font-poppins 
      ...
      <?php if ($about_description): echo esc_html($about_description);
      endif; ?>
    </p>

    <!-- Animated Button -->
    <a href="<?php echo esc_url($about_button_url); ?>" class="relative inline-flex items-center justify-center gap-2 
      ...
      <!-- Text + Icon -->
      <span
        class="relative z-10 flex items-center gap-2 text-black group-hover:text-white transition-colors duration-300">
        <?php if ($about_button_text): echo esc_html($about_button_text);
        endif; ?>
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="none">
          <path d="M1 7.00049L13 7.00049" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round" />
          <path d="M8 13.0001L14 7.00012L8 1.00012" stroke="currentColor" stroke-width="1.5"
    ...
    <div class="relative">
      ...
      <div class="absolute top-[40%] right-[-10%] sm:right-[-20%] md:right-[-50%] w-[150px] sm:w-[210px] md:w-[230px] lg:w-[250px] 
        ...
        <div class="absolute top-6 right-[15%] sm:right-[8%]">
          <div
            class="w-[60px] sm:w-[70px] lg:w-[80px] h-[60px] sm:h-[70px] lg:h-[80px] rounded-full bg-[#EBEFF3] flex items-center justify-center">
          </div>
          <h3
            class="text-[#142137] ml-[20%] mt-[-80%] sm:-mt-[70%] md:-mt-[60%] max-w-[20px] font-poppins text-[12px] sm:text-[13px] lg:text-[14px] font-medium">
            <?php if ($about_experience_year_text): echo esc_html($about_experience_year_text);
            endif; ?>
          </h3>
        </div>
  ...
  <!-- About Right -->
  <div
    class="about-right w-full items-center justify-start md:justify-center md:w-6/12 relative flex flex-col h-[250px] sm:h-[300px] md:h-auto">
    ...
    <div class="text-circle flex flex-wrap gap-[15px] md:gap-[20px] lg:gap-[25px] 2xl:pb-16">
      <div class="grid grid-cols-3 gap-6 justify-items-center">
        ...
        <div class="rounded-full border border-gray-300 flex flex-col justify-center items-center 
          ...
          <p
            class="text-[rgba(20,33,55,0.70)] font-poppins text-center text-[10px] sm:text-[12px] md:text-[14px] lg:text-[15px] leading-tight max-w-[90px] mt-1 sm:mt-2">
    ...
    <div
      class="absolute bottom-0 left-1/2 w-[300px] sm:w-[350px] md:w-[300px] lg:w-[400px] 2xl:w-[480px] transform -translate-x-1/2">
      <?php if ($about_right_image): ?>
        <img src="<?php echo esc_url($about_right_image); ?>" alt="about image"
