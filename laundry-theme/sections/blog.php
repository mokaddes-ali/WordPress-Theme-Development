  ...
  <div class="blog-cards grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-9">
    ...
    <div class="w-full h-auto bg-white overflow-hidden font-poppins relative">
      ...
      <div class="pt-4 flex justify-start gap-[18px] text-[15px] font-medium text-[rgba(20,33,55,0.7)] leading-[26px]">
        ...
        if($comments_count){
          if($comments_count === 0){
            $comment = esc_html__('No Comments', 'laundry_clean');
          }elseif($comments_count > 1){
            $comment = esc_html($comments_count) . ' ' . esc_html__('Comments', 'laundry_clean');
          }else{
            $comment = esc_html__('1 Comment', 'laundry_clean');
          }
          $comment = '<a href="' . get_comments_link() . '">' . $comment . '</a>';
        }else{
          $comment = esc_html__('No Comments', 'laundry_clean');
        }
    ...
    ?>
      ...
      <?php echo ' <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none">
      ...
      <div class="pt-4">
        <h2 class="text-[#142137] text-xl md:text-2xl font-semibold leading-[1.3] tracking-tight hover:underline hover:underline-offset-auto">
    ...
    <div class="w-full h-auto bg-white overflow-hidden font-poppins relative">
      <div class="w-full aspect-[3/2] overflow-hidden relative">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog1.png" alt="Card Image" class="w-full h-full object-cover" />
        <div class="absolute top-5 right-5 bg-[#4375E7] text-white text-[15px] font-medium leading-[26px] w-[98px] h-[26px] flex items-center justify-center rounded-sm">
          Eco Wash
        </div>
      </div>
    ...
    <div class="w-full h-auto bg-white overflow-hidden font-poppins relative">
      <div class="w-full aspect-[3/2] overflow-hidden relative">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog2.png" alt="Card Image" class="w-full h-full object-cover" />
        <div class="absolute top-5 right-5 bg-[#4375E7] text-white text-[15px] font-medium leading-[26px] w-[98px] h-[26px] flex items-center justify-center rounded-sm">
          Eco Wash
        </div>
      </div>
      ...
      <div class="w-full h-[1px] bg-[rgba(0,0,0,0.2)] mt-4"></div>
      <div class="pt-4">
        <h2 class="text-[#142137] text-xl md:text-2xl font-semibold leading-[1.3] tracking-tight underline underline-offset-auto decoration-solid decoration-1">
    ...
    <div class="w-full h-auto bg-white overflow-hidden font-poppins relative">
      <div class="w-full aspect-[3/2] overflow-hidden relative">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog3.png" alt="Card Image" class="w-full h-full object-cover" />
        <div class="absolute top-5 right-5 bg-[#4375E7] text-white text-[15px] font-medium leading-[26px] w-[98px] h-[26px] flex items-center justify-center rounded-sm">
          Eco Wash
        </div>
      </div>
    ...
    <div class="w-full h-auto bg-white overflow-hidden font-poppins relative">
      <div class="w-full aspect-[3/2] overflow-hidden relative">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog4.png" alt="Card Image" class="w-full h-full object-cover" />
        <div class="absolute top-5 right-5 bg-[#4375E7] text-white text-[15px] font-medium leading-[26px] w-[98px] h-[26px] flex items-center justify-center rounded-sm">
          Eco Wash
        </div>
      </div>
