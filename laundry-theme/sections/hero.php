 ...
 <section
     ...
     <div class="absolute top-[50%] left-[85%] z-50 flex flex-col gap-2">
         ...
         <!-- Prev Button -->
          <button id="custom-prev" class="w-[54px] h-[54px] flex items-center justify-center rounded-full hover:bg-[#4375E7] transition duration-300">
         ...
         <!-- Next Button -->
         <button id="custom-next" class="w-[54px] h-[54px] flex items-center justify-center rounded-full hover:bg-[#4375E7] transition duration-300">
             <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none">
