...
<section class="relative w-full">
    <div class="hero-slick-items">
        ...
        ?>
     <div class="hero-slick-single-item relative w-full h-[380px] sm:h-[400px] md:h-[450px] lg:w-[480px] 2xl:h-[500px]overflow-hidden flex items-center">
                <!-- Background Image -->
                <div>
                ...
                <!-- Hero Content -->
                <div class="z-50 relative flex flex-col gap-3 mx-auto w-[90%] lg:w-[85%] py-3 sm:py-4 md:py-5 lg:py-8 mx-auto text-white text-center md:text-start">
                    ...
                    <!-- Heading -->
                    <h1 class="text-white font-poppins w-full text-[2rem] sm:text-[2.75rem] md:text-[3.0rem] lg:text-[4.50rem] md:max-w-2xl lg:max-w-4xl xl:max-w-5xl font-semibold leading-[1.1] tracking-[-0.125rem]">
                        <?php echo esc_html(wp_trim_words($slider_title, 6)); ?>
                    </h1>

                    <!-- Description -->
                    <p class="text-white/70 font-poppins w-full md:w-[80%] lg:w-[48.125rem] md:pt-[0.5rem] text-sm sm:text-base md:text-[1.115rem] font-medium leading-[1.8]">
                    ...
                    <div class="flex justify-center flex-col sm:justify-start sm:flex-row items-center sm:items-center pt-1 md:pt-[1.5rem] gap-[1.25rem] sm:gap-[2rem]">
                        <!-- Animated Button-->
<button
  class="relative px-3 py-2 lg:px-5 lg:py-4 flex-shrink-0 rounded-lg font-poppins bg-[#4375E7] text-[12px] lg:text-[0.9375rem] font-medium overflow-hidden group">

  <!-- Background animation -->
  <span
    class="absolute inset-0 bg-[#4375E7] group-hover:bg-black 
  ...
  <a href="<?php echo esc_url($slider_button_link); ?>"
     class="relative z-10 text-white transition-colors duration-300">
