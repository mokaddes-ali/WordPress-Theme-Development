 ...
 * This template displays the hero section with a background image, overlay, design SVG, and content.
 *
 * @package Laundry Theme
 */
?>
...
<?php
    ...
    $slider_description= get_the_excerpt($post) ?: 'Our services are designed for convenience and efficiency, offering doorstep pickup &
delivery to make your laundry experience as seamless as possible.';
...
?>
    ...
    <!-- Background Image -->
    <div
        class="absolute inset-0 z-0 w-full h-full aspect-[1920/840] sm:aspect-[1920/840] md:aspect-[1920/840] lg:aspect-[1920/840] xl:aspect-[1920/840] 2xl:aspect-[1920/840]">
        <?php if($slider_background_image): ?>
        <img src="<?php echo esc_url($slider_background_image); ?>" alt="<?php echo esc_attr($slider_title); ?>"
    ...
    <div class="absolute inset-0 z-10">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Overly.png" alt="Overlay"
            class="w-full h-full object-cover" />
    </div>
    ...
    <div
        ...
        <!-- Heading -->
        <h1
            class="text-white font-poppins -ml-[0.25rem] w-full text-[2.5rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[6.25rem] md:max-w-2xl lg:max-w-4xl xl:max-w-5xl font-semibold leading-[1.1] tracking-[-0.125rem]">
            <?php if($slider_title): ?>
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center pt-[1.5rem] gap-[1.5rem] sm:gap-[2rem]">
            ...
            <div class="flex items-center gap-[1.125rem]">
                <img src="<?php echo esc_url($slider_avatar); ?>" alt="Client" class="w-[10.125rem] h-[3.375rem]" />
