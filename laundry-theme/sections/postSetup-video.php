...
if( has_post_format('video') ) {
    $video_url = get_post_meta(get_the_ID(), 'video_url', true); // ভিডিও URL
    if($video_url):
?>
    <div class="video-container">
        <iframe width="100%" height="400" src="<?php echo esc_url($video_url); ?>" frameborder="0" allowfullscreen></iframe>
    </div>
<?php
    endif;
}
...
<div class="max-w-[1140px] mx-auto mt-20 flex flex-col gap-8 px-4 md:px-0">
  ...
  <div class="flex flex-col lg:flex-row gap-6">
    <img 
      ...
      src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/blogdetail2.png" 
      alt="Blog Image"
    />
...
<div class="relative mt-8 md:mt-12 w-full mx-auto bg-[#EBEFF3] flex flex-col lg:flex-row gap-6 md:gap-9 lg:gap-12 p-4 md:p-6">
  ...
  <div class="w-full xl:w-[342px] h-72 md:w-[280px] md:h-[290px] flex-shrink-0 mx-auto md:mx-0">
    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/blogdetail3.png" alt="images" class="h-full w-full object-cover rounded-lg" />
  </div>
...
<div class="flex flex-col lg:flex-row justify-between gap-4 pt-20">
  ...
  <div class="flex w-full h-auto items-center border border-[rgba(20,33,55,0.14)] bg-transparent p-4 gap-4">
    ...
    <div class="w-24 h-28 flex-shrink-0">
      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/previewpost.png" alt="Previous post image" class="h-full w-full object-cover rounded-md" />
    </div>
    <!-- Text Section -->
  ...
  <!-- Next Post Card -->
  <div class="flex w-full  w-full h-auto items-center justify-end border border-[rgba(20,33,55,0.14)] bg-transparent p-4 gap-4">
    <!-- Text Section -->
    ...
    <!-- Image -->
    <div class="w-24 h-28 flex-shrink-0">
      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/nextpost.png" alt="Next post image" class="h-full w-full object-cover rounded-md" />
    </div>
  </div>
...
<div class="w-full space-y-6">
  ...
  <div class="w-full border-b border-b-[rgba(28,28,28,0.14)] pb-2.5">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start md:items-center mb-3 gap-3">
      ...
      <div class="flex flex-col xs:flex-row items-start xs:items-center gap-3 sm:gap-5 w-full sm:w-auto">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/blogcomment1.png" alt="User"
  ...
  <div class="w-full sm:ml-[10px] lg:ml-[80px] border-b border-b-[rgba(28,28,28,0.14)] pb-1.5">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-3">
      <!-- Left: Image, Name, Date -->
      <div class="flex flex-col xs:flex-row items-start xs:items-center gap-3 sm:gap-5 w-full sm:w-auto">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/blogcomment2.png" alt="User"
          class="w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] rounded-[6px] object-cover" />
