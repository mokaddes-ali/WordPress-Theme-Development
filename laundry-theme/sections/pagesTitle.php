...
<section class="relative mx-auto w-full px-[5%] lg:px-[7.5%] 
    ...
    <div class="relative z-50 container mx-auto text-white 
        ...
        <!-- Background Badge -->
        <div
            class=" rounded-[195px] bg-white/10 backdrop-blur-[7px] flex items-center justify-center gap-[10px] py-3 px-5">
            <!-- SVG Icon -->
            ...
            <div class="flex  items-center gap-1 sm:gap-2">
                ...
                <span
                    class="text-white hover:text-blue-300 hover:underline text-xs sm:text-sm md:text-[16px] font-medium">
                    <a
                        href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))) ?>"><?php esc_html(the_title()); ?></a>
                </span>
            </div>
        </div>
    </div>
