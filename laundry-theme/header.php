...
<body <?php body_class(); ?>>
    ...
    <?php endif; ?>
     "> -->
    <header class="w-full z-50 py-1.5 mb-1">
        <div class="custom-cotainer flex items-center justify-between gap-12 md:gap-6 2xl:gap-32">
            <!-- logo -->
            <div class="w-4/12 md:w-2/12 h-[30px] lg:h-[40px] flex items-center">
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    <?php if ($header_logo): ?>
                        <img src="<?php echo esc_url($header_logo); ?>"
                            alt="<?php esc_attr_e('Header Logo', 'laundryclean'); ?>" class="h-full w-[140px]">
                    <?php endif; ?>
                </a>
            </div>
            ...
            <div class="hidden md:flex w-full md:w-10/12 items-center justify-center gap-4 xl:gap-10">
                <nav
                    class="laundry_header-menu bg-white flex items-center justify-center gap-4 lg:gap-6 2xl:gap-10 w-full py-2 h-[21px]">
                    <?php
                    wp_nav_menu(array(
                ...
                shadow-sm transition-all duration-500 ease-in-out group">
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14"
                                fill="none" class="transition-all duration-300 ease-in-out">
            ...
            <div class="flex gap-6 md:hidden">
                ...
                <div class="md:hidden relative">
                    ...
                    <button id="menuBtn" class="z-50 p-2">
                        <!-- Open Icon -->
                        <svg id="openIcon" class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            stroke-width="2">
                ...
                <!-- Fullscreen Menu -->
                <div id="navPhone"
                    class="mobile-menu absolute top-16 right-0 w-full h-screen p-5 bg-black/80 flex flex-col items-center space-y-4 text-white text-xl opacity-0 invisible scale-95 transition-all duration-500 ease-in-out z-40">
                    <!-- Top Close Button -->
