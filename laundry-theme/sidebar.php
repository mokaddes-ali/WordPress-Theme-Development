<!-- Blog Right Sidebar -->
    <div class="blog-sidebar sticky top-0 h-fit w-full md:w-4/12 flex flex-col gap-6 md:gap-[27px] ">

      <!-- For mobile device only -->
       <div class="flex flex-row h-[130px] gap-6 md:hidden">

         <!-- search section -->
        <div class="w-6/12 bg-[#EBEFF3] p-4 sm:p-5 text-[#142137] font-poppins text-xl font-semibold leading-relaxed  tracking-tight">
            ...
            <div class="relative w-full md:w-[318px] mb-6 md:mb-0">
              ...
              <path d="M29.9995 29.9995L26.1328 26.1328" stroke="white" stroke-width="1.5" stroke-linecap="round"
        ...
        <div class="w-6/12 p-4 sm:p-5 bg-[#EBEFF3] text-[#142137] font-poppins">
            <!-- Title -->
            <h2 class="text-xl md:text-[24px] font-semibold leading-relaxed md:leading-[34px] mb-3 tracking-tight md:tracking-[-0.48px]">
                Follow Us
            </h2>
        ...
        <!-- search section for md device -->
        <div class="search-area hidden md:flex md:flex-col md:w-auto lg:w-[380px] md:h-[165px]  bg-[#EBEFF3] p-6 text-[#142137] font-poppins text-xl md:text-[24px] font-semibold leading-relaxed md:leading-[34px] tracking-tight md:tracking-[-0.48px]">
        ...
        <!-- Recent Posts Card -->
       <div
         class="w-full lg:w-[380px] h-auto lg:h-[469px] bg-[#EBEFF3] p-5 md:p-6 text-[#142137] font-poppins"
          >
            <!-- Title -->
           ...
           <!-- Post Rows -->
        <div class="flex flex-row flex-wrap gap-4 md:flex-col md:flex-nowrap md:gap-6">
          <!-- Single Row -->
              ...
              <div class="flex items-center gap-1.5 text-[15px] text-[#142137B3] leading-[26px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
                  <path d="M5.5 1V3.69865" stroke="#142137" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M12.6953 1V3.69865" stroke="#142137" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M4.59766 10.8955H11.7941" stroke="#142137" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M4.59766 14.4932H9.09541" stroke="#142137" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path
        ...
        <!-- Category Card -->
        <div class="w-full lg:w-[380px] h-auto md:h-[407px] flex-shrink-0 bg-[#EBEFF3] p-5 md:p-6 text-[#142137] font-poppins">
            <!-- Title -->
            <h2 class="text-xl md:text-[24px] font-semibold leading-relaxed md:leading-[34px] mb-6 tracking-tight md:tracking-[-0.48px]">
                Categories
            </h2>
  ...
  <div
    ...
    <span class="text-[15px] text-[#142137B3] font-medium leading-[26px]">(7)</span>
        ...
        <div class="w-full lg:w-[380px] h-auto flex-shrink-0 bg-[#EBEFF3] p-5 md:p-6 text-[#142137] font-poppins">
            <!-- Title -->
            <h2 class="text-xl md:text-[24px] font-semibold leading-relaxed md:leading-[34px] mb-4 tracking-tight md:tracking-[-0.48px]">
                Popular Tags
            </h2>

            <!-- Tag List -->
            <div class="flex mt-3 md:mt-4 flex-wrap gap-2 md:gap-[10px]">
                  <!-- Row 1 - 4 Tags -->
          <span
        ...
        <!-- Follow Us Card -->
        <div class="w-full hidden md:flex md:flex-col lg:w-[380px] h-auto md:h-[171px] flex-shrink-0 bg-[#EBEFF3] px-6 md:pl-[30px] md:pt-[24px] text-[#142137] font-poppins">
            <!-- Title -->
            <h2 class="text-xl md:text-[24px] font-semibold leading-relaxed md:leading-[34px] mb-6 tracking-tight md:tracking-[-0.48px]">
                Follow Us
            </h2>
            ...
            <div class="flex items-center gap-2 md:gap-2.5">
                <a href="<?php echo esc_url(get_theme_mod('company_facebook')); ?>"
            target="_blank" rel="noopener noreferrer" class="flex items-center justify-center bg-white rounded-full shadow hover:bg-orange-500 hover:text-white transition">
          ...
          <a href="<?php echo esc_url(get_theme_mod('company_twitter')); ?>"
            target="_blank" rel="noopener noreferrer" class=" flex items-center justify-center bg-white rounded-full shadow hover:bg-orange-500 hover:text-white transition">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
              <circle cx="25" cy="25" r="25" fill="#040618" />
              <path
          ...
          <a href="<?php echo esc_url(get_theme_mod('company_linkedin')); ?>"
            target="_blank" rel="noopener noreferrer" class="flex items-center justify-center bg-white rounded-full shadow hover:bg-orange-500 hover:text-white transition">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
              <circle cx="25" cy="25" r="25" fill="#0A66C2" />
              <path
          ...
          <a href="<?php echo esc_url(get_theme_mod('company_pinterest')); ?>"
            target="_blank" rel="noopener noreferrer" class="flex items-center justify-center bg-white rounded-full shadow hover:bg-orange-500 hover:text-white transition">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
              <circle cx="25" cy="25" r="25" fill="#CB2027" />
              <path
