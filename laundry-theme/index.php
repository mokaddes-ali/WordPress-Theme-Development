...
?>
  ...
  <!-- Blog Hero Area -->
    <section
        class="relative mx-auto mt-20 w-full px-[2.5%] lg:px-[5%] 2xl:px-[8%] py-12 md:py-16 lg:py-20 xl:py-24 h-[250px] sm:h-[300px] md:h-[350px] lg:h-[370px] bg-cover bg-center bg-no-repeat "
        ...
        <div class="container mx-auto text-white h-full flex flex-col justify-center">
            ...
            <h1
                ...
                <?php echo esc_html_e('Blog', 'laundry-theme'); ?>

            </h1>

            <!-- Background Badge -->
            <div
                class="w-[200px] sm:w-[230px] max-w-[240px] h-[34px] rounded-[195px] bg-white/10 backdrop-blur-[7px] flex items-center justify-center gap-[10px] px-3 sm:px-4">
                ...
                <div class="flex items-center gap-1 sm:gap-2">
                    ...
                    <span
                        ...
                        <a href="<?php echo esc_url(home_url('/')); ?>">
                          <?php esc_html_e('Home', 'laundry-theme'); ?>
                        </a>
                    </span>
                    ...
                    <span
                        ...
                        <?php esc_html_e('Blog', 'laundry-theme'); ?>
                    </span>
                </div>
            </div>
        </div>
