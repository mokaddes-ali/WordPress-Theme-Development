    ...
    <div class="blog-left  w-full md:w-8/12">
        ...
        <div class="w-full">
            ...
            <div class="w-full h-auto aspect-[1160/570]">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blogdetail1.png" alt="Blog detail image" class="w-full h-full object-cover" />
            </div>
            ...
            <div class="py-4 md:py-5 xl:pr-4 flex flex-col gap-3 md:gap-[12px]">
                ...
                <div class="flex flex-wrap items-center gap-3 md:gap-[13px]">
                    ...
                    <div class="w-10 h-10 md:w-[54px] md:h-[54px] flex-shrink-0 rounded-[6px] bg-[#CFD4C6] overflow-hidden">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/postclient1.jpg" class="w-full h-full object-cover" />
                    </div>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none"
                ...
                <path
                  ...
                  fill="#1D92CD" />
                    ...
                    <!-- Date -->
                    <div class="text-[rgba(20,33,55,0.60)] pl-1 md:pl-[7px] flex items-center gap-1 md:gap-[7px] text-center font-poppins text-sm md:text-[16px] font-medium leading-[26px]">
                        <!-- Calendar Icon -->
             ...
             <!-- Four Row Section -->
<div class="flex flex-col gap-8 pt-3 md:pt-5 xl:pt-8">

  <!-- Row with left & right items -->
  <div class="flex flex-col lg:flex-row lg:justify-between gap-8">
    ...
    <div class="flex-1 flex flex-col gap-4">
      <div class="flex items-center gap-3">
        <!-- SVG -->
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 flex-shrink-0" viewBox="0 0 22 22" fill="none">
          <path d="M11 22C17.0751 22 22 17.0751 22 11C22 4.92487 17.0751 0 11 0C4.92487 0 0 4.92487 0 11C0 17.0751 4.92487 22 11 22Z" fill="#4375E7"/>
          <path d="M15.5 8L9.3125 14L6.5 11.2727" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        <h1 class="text-[#142137] font-poppins text-lg font-medium leading-snug">
          Professional Dry Cleaning & Laundry
        </h1>
      </div>
      <p class="text-gray-700 text-base leading-relaxed">
        Cleaning is more than just visiting places creating memories discovering new cultures.
      </p>
    </div>
  ...
  <p class="text-gray-700 text-base leading-relaxed max-w-4xl">
    Cleaning is more than just visiting places—it's about creating lasting memories, discovering new cultures,
    and experiencing the extraordinary. From breathtaking landscapes to immersive local adventures, we curate
...
<div class="relative bg-[#EBEFF3] rounded-lg mt-5 lg:mt-10 p-4 md:p-6 flex flex-col items-center text-center gap-6">
  ...
  <p class="text-gray-700 text-base md:text-lg leading-relaxed max-w-4xl">
    Cleaning is more than just visiting places—it's about creating lasting memories, discovering new cultures, experiencing the extraordinary. From breathtaking landscapes to immersive adventures, we create seamless travel experiences tailored to your dreams. Whether adventure or exploration, we are here to turn your journey into memories.
  </p>
...
<div class="max-w-[1140px] mx-auto mt-20 flex flex-col gap-8 px-4 md:px-0">
  ...
  <div class="flex flex-col lg:flex-row gap-6">
    <img 
      ...
      src="<?php echo get_template_directory_uri(); ?>/assets/images/blogdetail2.png" 
      alt="Blog Image"
    />
    ...
    <div class="flex gap-6 lg:gap-8 w-full">
      ...
      <div class="flex flex-col gap-4 lg:pt-1">
        <h1 class="text-[#142137] font-medium text-xl md:text-2xl lg:text-2xl leading-snug tracking-tight font-poppins">
          A picture speaks of quality—just like fresh, professionally cleaned clothes.
        </h1>

        <p class="text-slate-800/70 text-base md:text-base leading-relaxed font-poppins">
          Cleaning is more than just visiting places—it's about creating lasting memories, discovering new cultures, 
          and experiencing the extraordinary. From breathtaking landscapes to immersive adventures, we curate 
          seamless experiences tailored to your dreams. Whether you seek relaxation, adventure, or cultural 
          exploration, we are here.
        </p>
      </div>
    </div>
  </div>
  ...
  <div>
    <p class="text-slate-800/70 text-base md:text-base leading-relaxed font-poppins">
      Cleaning is more than just visiting places—it's about creating lasting memories, discovering new cultures, 
      and experiencing the extraordinary. From breathtaking landscapes to immersive local adventures, we curate 
      seamless travel experiences tailored to your dreams. Whether you seek relaxation, adventure, or cultural 
      exploration, we are here to turn your journey into something unforgettable.
    </p>
  </div>
</div>
...
<!-- Four Card Author -->
<div class="relative mt-8 md:mt-12 w-full mx-auto bg-[#EBEFF3] flex flex-col lg:flex-row gap-6 md:gap-9 lg:gap-12 p-4 md:p-6">

  <!-- Image Section -->
  <div class="w-full xl:w-[342px] h-72 md:w-[280px] md:h-[290px] flex-shrink-0 mx-auto md:mx-0">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blogdetail3.png" alt="images" class="h-full w-full object-cover rounded-lg" />
  </div>

  <!-- Text Section -->
  <div class="w-full flex flex-col pt-6 md:pt-9 gap-6 md:gap-8">
    ...
    <p class="text-[rgba(20,33,55,0.7)] w-full text-base lg:text-lg leading-relaxed font-medium font-poppins -mt-2">
      We believe that fresh clean clothes bring confidence and comfort. With a passion for quality
      and convenience, we provide top-notch laundry & dry cleaning services tailored to meet your needs.
    </p>
    ...
    <div class="flex flex-col sm:flex-row justify-between pt-2 gap-4 sm:gap-0">
      ...
      <div class="flex items-center gap-2 text-[#142137] text-base font-medium font-poppins">
        See All Post
        <svg class="w-3 h-3 shrink-0" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
          <path d="M1 7.00024L13 7.00024" stroke="#142137" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M7 1L13 7L7 13" stroke="#142137" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </div>
        ...
        <div class="flex flex-col lg:flex-row justify-between gap-4 pt-8 md:pt-[80px]">
            <div class="flex items-center gap-3 md:gap-[12px]">
                <h2 class="text-[#142137] text-xl md:text-[24px] leading-relaxed md:leading-[34px] font-medium md:font-[500] tracking-tight md:tracking-[-0.48px] font-poppins">
                    Related Tags:
                </h2>

                <!-- Tag List -->
                <div class="flex flex-wrap gap-2 md:gap-[9px]">
                    <span class="h-[28px] px-2 text-sm md:text-[15px] font-medium leading-relaxed md:leading-[26px] tracking-tight md:tracking-[-0.3px] text-[#142137B3] border border-[#14213723] flex items-center justify-center">Fresh</span>
                    <span class="h-[28px] px-2 text-sm md:text-[15px] font-medium leading-relaxed md:leading-[26px] tracking-tight md:tracking-[-0.3px] text-white border border-[#14213723] bg-[#4375E7] flex items-center justify-center">Flawless</span>
                    <span class="h-[28px] px-2 text-sm md:text-[15px] font-medium leading-relaxed md:leading-[26px] tracking-tight md:tracking-[-0.3px] text-[#142137B3] border border-[#14213723] flex items-center justify-center">Clean</span>
                    <span class="h-[28px] px-2 text-sm md:text-[15px] font-medium leading-relaxed md:leading-[26px] tracking-tight md:tracking-[-0.3px] text-[#142137B3] border border-[#14213723] flex items-center justify-center">Crisp</span>
                </div>
            </div>

            <!-- social icon -->
            <div class="social-icon flex flex-col md:flex-row gap-3 md:gap-[14px] items-center">
                <h2 class="text-[#142137] text-xl md:text-[24px] leading-relaxed md:leading-[34px] font-medium md:font-[500] tracking-tight md:tracking-[-0.48px] font-poppins">Social Share:</h2>
                <!-- icon list -->
...
<div class="flex flex-col lg:flex-row justify-between gap-4 pt-20">
  ...
  <!-- Previous Post Card -->
  <div class="flex w-full h-auto items-center border border-[rgba(20,33,55,0.14)] bg-transparent p-4 gap-4">
    <!-- Image -->
    <div class="w-24 h-28 flex-shrink-0">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/previewpost.png" alt="Previous post image" class="h-full w-full object-cover rounded-md" />
    </div>
    <!-- Text Section -->
    <div class="flex flex-col justify-center gap-2">
      ...
      <h4 class="text-[#142137] text-lg md:text-xl font-semibold leading-snug font-poppins">
        How to Keep Your Garments Fresh &<br />
        Clean Laundry Tips.
      </h4>
    </div>
  </div>
  ...
  <!-- Next Post Card -->
  <div class="flex w-full  h-auto items-center justify-end border border-[rgba(20,33,55,0.14)] bg-transparent p-4 gap-4">
    <!-- Text Section -->
    ...
    <!-- Image -->
    <div class="w-24 h-28 flex-shrink-0">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/nextpost.png" alt="Next post image" class="h-full w-full object-cover rounded-md" />
    </div>
  </div>
        ...
        <div class="comment-area w-full flex flex-col gap-6 md:gap-[24px] py-12 md:py-[85px]">
            ...
            <div class="comment-heading">
                <h1 class="text-[#142137] font-poppins text-3xl md:text-[44px] font-semibold leading-relaxed md:leading-[64px] tracking-tight md:tracking-[-0.88px]">2 Comments</h1>
            </div>
...
<div class="w-full space-y-6">
  ...
  <div class="w-full border-b border-b-[rgba(28,28,28,0.14)] pb-2.5">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start md:items-center mb-3 gap-3">
      ...
      <div class="flex flex-col xs:flex-row items-start xs:items-center gap-3 sm:gap-5 w-full sm:w-auto">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blogcomment1.png" alt="User"
          class="w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] rounded-[6px] object-cover" />
        <div class="flex flex-col gap-1 sm:gap-[13px]">
          <h4 class="text-[#142137] font-poppins text-[16px] sm:text-[18px] font-semibold not-italic leading-none">Norman Gordon</h4>
          <p class="text-[#616161] font-inter text-[14px] sm:text-[16px] font-medium not-italic leading-[26px]">March 23,2025 at 10:34 pm</p>
        </div>
      </div>
    ...
    <!-- Bottom: Message -->
    <p class="text-[rgba(20,33,55,0.7)] pl-[65px] sm:pl-[80px] mt-3 sm:mt-[20px] font-poppins text-[14px] sm:text-[16px] font-normal not-italic leading-[22px] sm:leading-[26px]">
      Travel is more than just visiting places—it's about creating lasting memories, discovering new cultures, and
  ...
  <div class="w-full sm:ml-[10px] lg:ml-[80px] border-b border-b-[rgba(28,28,28,0.14)] pb-1.5">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-3">
      <!-- Left: Image, Name, Date -->
      <div class="flex flex-col xs:flex-row items-start xs:items-center gap-3 sm:gap-5 w-full sm:w-auto">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blogcomment2.png" alt="User"
          class="w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] rounded-[6px] object-cover" />
        <div class="flex flex-col gap-1 sm:gap-[10px] pt-0 sm:pt-[5px]">
          <h4 class="text-[#142137] font-poppins text-[16px] sm:text-[18px] font-semibold not-italic leading-none">Norman Gordon</h4>
          <p class="text-[#616161] font-inter text-[14px] sm:text-[16px] font-medium not-italic leading-[26px]">April 28,2025 at 08:37 pm</p>
        </div>
      </div>
...
<div class="write-comment-area mb-2 md:mb-[8px]">
  ...
  <div class="heading mb-3 md:mb-[14px]">
    <h2 class="text-[#142137] font-poppins text-2xl sm:text-3xl md:text-4xl lg:text-[44px] font-semibold leading-[1.3] md:leading-[64px] tracking-tight md:tracking-[-0.88px]">
      Leave a Comment
    </h2>
  </div>

  <form class="w-full mx-auto space-y-4 md:space-y-6 font-poppins text-sm sm:text-base text-[rgba(20,33,55,0.7)] leading-snug md:leading-[26px]">
      ...
      <button type="submit"
        ...
        <span class="w-6 h-6 sm:w-[34px] sm:h-[34px] rounded-[50px] bg-white flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="none">
            <path d="M0.853516 7.16162L12.8535 7.16162" stroke="#142137" stroke-width="1.5" stroke-linecap="round"
              stroke-linejoin="round" />
