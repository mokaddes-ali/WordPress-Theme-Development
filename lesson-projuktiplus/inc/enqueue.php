...
wp_localize_script('register-ajax-js', 'lessonlms_ajax_register_object', array(
    'ajax_url' => admin_url('admin-ajax.php'),
...
wp_localize_script('restet-password-js', 'lessonlms_ajax_reset_password_object', array(
    'ajax_url' => admin_url('admin-ajax.php'),
