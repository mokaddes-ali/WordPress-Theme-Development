	...
	<div class="hero-slider">
		...
		if ($slider_query->have_posts()) :
			while ($slider_query->have_posts()) : $slider_query->the_post();
				...
				// Custom Fields
				$button1_text = get_post_meta(get_the_ID(), '_button1_text', true);
				$button1_url  = get_post_meta(get_the_ID(), '_button1_url', true);
				$button2_text = get_post_meta(get_the_ID(), '_button2_text', true);
				$button2_url  = get_post_meta(get_the_ID(), '_button2_url', true);
				$thumbnail_url = '';

				if (has_post_thumbnail(get_the_ID())) {
					$thumbnail_url = get_the_post_thumbnail_url(get_the_ID(), 'full');
				} else {
					$thumbnail_url = 'https://via.placeholder.com/1200x900?text=No+Image';
				}
		?>
				<!-- Start Single Slider -->
								...
								<div class="text">
									...
									<div class="button">
										<?php if (!empty($button1_text) && !empty($button1_url)) : ?>
											<a href="<?php echo esc_url($button1_url); ?>" class="btn"><?php echo esc_html($button1_text); ?></a>
										<?php endif; ?>
										<?php if (!empty($button2_text) && !empty($button2_url)) : ?>
											<a href="<?php echo esc_url($button2_url); ?>" class="btn primary"><?php echo esc_html($button2_text); ?></a>
										<?php endif; ?>
									</div>
								</div>
							</div>
